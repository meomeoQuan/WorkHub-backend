...
namespace WorkHub.Controllers.Users
{
    ...
    public class HomeController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetTop4() { 
            ...
            var entities = await _unitOfWork.RecruitmentInfoRepo.GetTopAsync(4, orderBy: r => r.CreatedAt, descending: true, includeProperties: SD.Collection_Join_PostRecruitments + ".Post," + SD.Join_User ); // descending is latest first
        ...
        {
            var entity = await _unitOfWork.RecruitmentInfoRepo.GetAsync(r => r.Id.ToString() == jobId, includeProperties: SD.Join_User + "," + SD.Collection_Join_PostRecruitments + ".Post,JobType,Category," + SD.Join_User + "." + SD.Join_UserDetail);
